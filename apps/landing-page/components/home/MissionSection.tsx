        ...
        <div className="flex flex-col md:flex-row gap-16 items-center justify-center">
          ...
          >
            ...
            <p className="font-outfit font-normal text-[18px] leading-[1.6] text-[#033604]/80">
              Volteryde exists to transform public transportation in Ghana by
              delivering clean, reliable, and technology-driven electric bus
              services that improve everyday commuting while protecting the
              environment.
            </p>
          </motion.div>
        </div>
